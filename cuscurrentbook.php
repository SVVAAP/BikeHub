...
<div>
    <div>
        <h1 style="margin-bottom: 25px; text-align: center; font-size: 30px;">Your Current Bookings</h1>
    </div>
</div>
...
<div class="container">
    <div class="jumbotron">
        <h1  style="text-align: center; font-size: 30px;">No bikes are currently Booked</h1>
        <p></p>
    </div>
</div>
<?php 
